        ...
        children: [
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: 'Future AI-TRiSM',
              asset: AppAssets.work5,
              hover: isApp,
            ),
          ),
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: 'AI-TRiSM Privacy',
              asset: AppAssets.work6,
              hover: isGraphic,
            ),
          ),
          Constants.sizedBox(height: 24.0),
          InkWell(
            ...
            child: buildAnimatedContainer(
              title: 'AI-TRiSM security',
              asset: AppAssets.work7,
              hover: isDataAnalyst,
            ),
          )
        ],
    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          ...
          Text(
            'The rapid ascent of artificial intelligence (AI) has catalyzed a revolution in various sectors, delivering matchless efficiency, automation, '
